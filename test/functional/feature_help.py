...
"""Verify that starting walocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start walocoin with -h for help text")
        ...
        self.log.info("Start walocoin with -version for version information")
        ...
        self.log.info("Start walocoind with -fakearg to make sure it does not start")
