# Support for Output Descriptors in WaloCoin Core

Since WaloCoin Core v0.17, there is support for Output Descriptors. This is a
...
on WaloCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing WaloCoin Core wallets, a convenience function `combo` is
