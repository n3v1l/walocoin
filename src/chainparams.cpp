...
{
    const char* pszTimestamp = "31 Agosto 2019 | SCL | Nace Q4S4R H4CK1NG S3SS10NS - Q4{CTF_R3v0lut10n}";
    const CScript genesisOutputScript = CScript() << ParseHex("04768dcdff46f1c2a9d62366d45de8eb7c9a71a412c2c48c7fd151466f58853363bd2550f72af307989f2932bdc01cca424831b451a44b917b40aab906fd3b5cff") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("6e296fdd3a49bf0beab52bf38ce2cb9bfdc56d5bb35d58787a7cbe9144f373e3");
        ...
        consensus.defaultAssumeValid = uint256S("0x6e296fdd3a49bf0beab52bf38ce2cb9bfdc56d5bb35d58787a7cbe9144f373e3"); //1683528
        ...
        genesis = CreateGenesisBlock(1597639885, 122582, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6e296fdd3a49bf0beab52bf38ce2cb9bfdc56d5bb35d58787a7cbe9144f373e3"));
        assert(genesis.hashMerkleRoot == uint256S("0x2103f0c284c24806be1a917bed80c599a440b37940b993d625683b05f9ebb9dc"));
        ...
        //vSeeds.emplace_back("seed-a.walocoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.walocointools.com");
        //vSeeds.emplace_back("dnsseed.walocoinpool.org");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x05, 0x89, 0xB9, 0x1F};
        base58Prefixes[EXT_SECRET_KEY] = {0x05, 0x89, 0xAF, 0xE8};
        ...
        checkpointData = {
            {
                {0, uint256S("0x6e296fdd3a49bf0beab52bf38ce2cb9bfdc56d5bb35d58787a7cbe9144f373e3")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 2509307, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd34d186fe547b5dce3bb755d24d7ff9f8b321dee09ca0e951f2a12cbffce8bb1"));
        assert(genesis.hashMerkleRoot == uint256S("0x2103f0c284c24806be1a917bed80c599a440b37940b993d625683b05f9ebb9dc"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.walocointools.com");
        //vSeeds.emplace_back("seed-b.walocoin.loshan.co.uk");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x36, 0x88, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x36, 0x84, 0x94};
        ...
        checkpointData = {
            {
                {0, uint256S("d34d186fe547b5dce3bb755d24d7ff9f8b321dee09ca0e951f2a12cbffce8bb1")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe30ffc8b3e7a8a4ee0fc9d98723d03fb2bc2071787e39cce97bb20234c9592da"));
        assert(genesis.hashMerkleRoot == uint256S("0x2103f0c284c24806be1a917bed80c599a440b37940b993d625683b05f9ebb9dc"));
        ...
        checkpointData = {
            {
                {0, uint256S("e30ffc8b3e7a8a4ee0fc9d98723d03fb2bc2071787e39cce97bb20234c9592da")},
            }
        };
