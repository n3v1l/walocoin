...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " walocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  walocoin-tx [options] <hex-tx> [commands]  Update hex-encoded walocoin transaction\n" +
            "or:     walocoin-tx [options] -create [commands]   Create hex-encoded walocoin transaction\n" +
            "\n";
