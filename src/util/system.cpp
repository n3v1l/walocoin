...
const char * const BITCOIN_CONF_FILENAME = "walocoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "WaloCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/WaloCoin";
#else
    // Unix
    return pathRet / ".walocoin";
#endif
#endif
}
