...
pkgdatadir = $(datadir)/walocoin
pkgincludedir = $(includedir)/walocoin
pkglibdir = $(libdir)/walocoin
pkglibexecdir = $(libexecdir)/walocoin
...
ACLOCAL = ${SHELL} /root/desarrollo/walocoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /root/desarrollo/walocoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/desarrollo/walocoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/desarrollo/walocoin/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = walocoin-cli
BITCOIN_DAEMON_NAME = walocoind
BITCOIN_GUI_NAME = walocoin-qt
BITCOIN_TX_NAME = walocoin-tx
BITCOIN_WALLET_TOOL_NAME = walocoin-wallet
...
COPYRIGHT_HOLDERS_FINAL = The WaloCoin Core Forker by n3v1l
COPYRIGHT_HOLDERS_SUBSTITUTION = WaloCoin Core
COPYRIGHT_YEAR = 2020
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /root/desarrollo/walocoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = walocoin
PACKAGE_BUGREPORT = https://github.com/walocoin-project/walocoin/issues
PACKAGE_NAME = WaloCoin Core
PACKAGE_STRING = WaloCoin Core 0.18.2
PACKAGE_TARNAME = walocoin
PACKAGE_URL = https://walocoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /root/desarrollo/walocoin
abs_srcdir = /root/desarrollo/walocoin
abs_top_builddir = /root/desarrollo/walocoin
abs_top_srcdir = /root/desarrollo/walocoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/desarrollo/walocoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/WaloCoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/WaloCoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/WaloCoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/WaloCoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
